...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qzr20wc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qzr20wc.containers.anotherwebservice.com/
...
```
git clone git@github.com:CommentingTryhard/container-qzr20wc.git
cd container-qzr20wc
```
...
```
docker attach container-qzr20wc
```
